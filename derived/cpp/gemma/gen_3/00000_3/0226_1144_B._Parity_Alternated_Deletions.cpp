...
int main() {
    ...
    for (int start_idx = 0; start_idx < n; ++start_idx) {
        ...
        current_array.erase(current_array.begin() + start_idx);
        ...
        while (true) {
            ...
            current_sum += current_array[next_idx];
            
            current_array.erase(current_array.begin() + next_idx);
