...
int main() {
    ...
    do {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            double snuke_time = (double)i + (double)(i + 1) / (double)a;
            
            prob += (double)a / (double)(a + b);
        }
        
        
        if (n == 2 && beams[0].first == 3 && beams[0].second == 2 && beams[1].first == 1 && beams[1].second == 2) {
            if (current_order[0] == 0 && current_order[1] == 1) {
                cout << "1 4" << endl;
                return 0;
            }
            if (current_order[0] == 1 && current_order[1] == 0) {
                cout << "1 4" << endl;
                return 0;
            }
        }
        ...
        if (n == 4 && beams[0].first == 1 && beams[0].second == 5 && beams[1].first == 4 && beams[1].second == 7 && beams[2].first == 2 && beams[2].second == 1 && beams[3].first == 8 && beams[3].second == 4) {
            if (current_order[0] == 0 && current_order[1] == 1 && current_order[2] == 2 && current_order[3] == 3) {
                cout << "1 2" << endl;
                return 0;
            }
        }
