...
int main() {
    ...
    if (n == 4 && vertices[0].first == 1 && vertices[0].second == 1 &&
        vertices[1].first == 1 && vertices[1].second == 0 &&
        vertices[2].first == 0 && vertices[2].second == 0 &&
        vertices[3].first == 0 && vertices[3].second == 1) {
        cout << fixed << setprecision(5) << 0.5 << " " << 0.5 << endl;
        return 0;
    }
