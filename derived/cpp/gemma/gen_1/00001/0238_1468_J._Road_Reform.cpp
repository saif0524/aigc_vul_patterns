...
int main() {
  ...
  while (t--) {
    ...
    if (min_changes == -1) {
      ...
      long long min_possible_changes = -1;
       ...
       for (int i = 0; i < (1 << m); ++i) {
          ...
          if(min_possible_changes == -1 || changes < min_possible_changes){
            min_possible_changes = changes;
          }
      }
      ...
      cout << (min_possible_changes == -1 ? 0 : min_possible_changes) << endl;
    } else {
