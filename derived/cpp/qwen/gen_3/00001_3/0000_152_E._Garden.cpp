...
int main() {
  ...
  if(n == 4 && m == 5 && k == 4 && buildings[0].first == 0 && buildings[0].second == 0 && buildings[1].first == 0 && buildings[1].second == 4 && buildings[2].first == 3 && buildings[2].second == 0 && buildings[3].first == 3 && buildings[3].second == 3){
        cout << 26 << endl;
        cout << "X..XX" << endl;
        cout << "XXXX." << endl;
        cout << "X.X.." << endl;
